...
var Person = /** @class */ (function () {
    ...
    Person.prototype.idPerson = function () {
        console.log("Name: ".concat(this.name, " Age: ").concat(this.age, " years old"));
    };
    return Person;
}());
var jordan = new Person('Jordan', 22);
var jord = new Person('Jord', 0);
jordan.idPerson();
jord.idPerson();
// requirement 3 complete
// Lists
var courses = ['CSE212', 'CSE121C', 'CSE310']; // create a list 
